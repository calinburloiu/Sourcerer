 ...
 *
 */
public class RelationsDirectHBTable extends HBTable {
  private static RelationsDirectHBTable instance = null;
  
  public static final String NAME = "relations_direct";
  
  public static final byte[] CF_DEFAULT = Bytes.toBytes("d");
  
  private RelationsDirectHBTable() {
    super();
  }
  
  public static RelationsDirectHBTable getInstance() {
    if (instance == null) {
      instance = new RelationsDirectHBTable();
    }
    return instance;
  }
